...
def backup_to_file(payload: Dict[str, Any], file_name: str, item_type: str):
    # This function would handle saving the data
    print(f"Backing up data for {item_type} to {file_name}")
